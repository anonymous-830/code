 ...
 * ----------------
 */
#define RIPPLE_LEFT_PAGE_SIZE 1048576
#define RIPPLE_RIGHT_PAGE_SIZE 1048576
...
typedef struct PlanState
{
	 ...
	 */
	TupleTableSlot *rippleLeftPage[RIPPLE_LEFT_PAGE_SIZE];
	TupleTableSlot *rippleRightPage[RIPPLE_RIGHT_PAGE_SIZE];
	
	/*
	 * Online ripple join variables
	 */
	int LeftReward[RIPPLE_LEFT_PAGE_SIZE];
	int RightReward[RIPPLE_RIGHT_PAGE_SIZE];
} PlanState;
