...
/* Added for CL: */
#define PGNST8_RIGHT_PAGE_MAX_SIZE 10000
#define OSL_BND8_LEFT_TABLE_CACHE_MAX_SIZE 10000
typedef struct PlanState
{
	...
	/* Page Nested Loop Variables for Outer Relation */
	...
	unsigned int pgOuterReward[PGNST8_LEFT_PAGE_MAX_SIZE];
	unsigned int cursorOuterReward;
	bool zeroOuterRewardExists;

	/* Page Nested Loop Variables for Inner Relation */
    bool nl_needNewInnerPage;
	TupleTableSlot* pgNst8RightPage[PGNST8_RIGHT_PAGE_MAX_SIZE];
    unsigned int pgNst8RightPageHead;
    unsigned int pgNst8RightPageSize;
	bool pgNst8RightParsedFully;
    unsigned int pgNst8OuterTableParseCount;
	TupleTableSlot *pgNst8_outertuple[1];
	unsigned int pgInnerReward[PGNST8_RIGHT_PAGE_MAX_SIZE];
	unsigned int cursorInnerReward;
	bool zeroInnerRewardExists; 
	...
	*/
	...
	/* Exploration Trackers For Outer Relation */
	...
	bool oslBnd8LeftTableCacheInitialized;
	TupleTableSlot* oslBnd8LeftTableCache[OSL_BND8_LEFT_TABLE_CACHE_MAX_SIZE];
    unsigned int oslBnd8LeftTableCacheHead;
    unsigned int oslBnd8LeftTableCacheSize;

	/* Exploration Trackers For Inner Relation */
